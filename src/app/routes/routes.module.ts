...
const routes: Routes = [
  {
    ...
    { path: 'guide/section/:sectionIdOrSlug', component: GuideSectionPageComponent },
    { path: 'guide/section/:sectionIdOrSlug/article/:articleIdOrSlug', component: GuideSectionArticlePageComponent },
